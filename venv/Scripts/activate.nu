...
let virtual-env = "C:\CS_Python100Days\RESTful_API_blog-with-users-auth_comment\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\CS_Python100Days\RESTful_API_blog-with-users-auth_comment\venv\Scripts\deactivate.nu"
